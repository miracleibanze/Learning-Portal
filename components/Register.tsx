    ...
    <main className="w-full flex-1 h-full container flex items-center justify-center relative">
      ...
      <div className="shadow-lg w-full sm:max-w-lg max-w-md rounded-2xl backdrop-blur-3xl bg-black/40 z-[10] overflow-hidden border-white/50 border-2">
        ...
        >
          ...
          {step === 0 && (
            <>
              ...
              <div className="w-full flex justify-end">
                <button
                  className={`button rounded-full !bg-blue-700 text-white relative left-0`}
                  onClick={() => setStep(1)}
                >
                  Next
                </button>
          ...
          {step === 1 && (
            <>
              <button
                ...
                className={`slide-in button rounded-full border hover:border-blue-700 text-zinc-800 relative left-0 mb-8`}
                onClick={() => setStep(0)}
              >
              ...
              <div className="slide-in mt-1 w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500  bg-transparent text-focus:border-blue-500 flex mb-4">
                <input
              ...
              <div className="slide-in space-y-1">
                ...
                <div className="mt-1 w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500  bg-transparent text-white focus:border-blue-500 flex">
                  <input
                    type={showPassword ? "text" : "password"}
                    id="password"
                    value={password}
                    ...
                    <i
                      className={`fas rounded-full text-xl p-1 px-2 flex items-center justify-center ${
                        password === passwordTest
                          ? password !== "" && "fa-check text-green-500"
                          : "fa-times text-red-500"
                      }`}
                    ></i>
                  </span>
            ...
            <>
              ...
              <div className="slide-in mb-4">
                ...
                <select
                  id="role"
                  name="role"
                  className="input !text-white w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
                  onChange={handleFormData}
              ...
              <button
                ...
                className={`slide-in button rounded-full text-white w-full py-3 text-lg font-medium shadow-md transition duration-200 bg-blue-700 hover:bg-blue-800`}
              >
          ...
          <p className="pt-4 mt-4 border-t border-blue-300">
            Arleady have account?{" "}
            <span className="!text-blue-600" onClick={() => redirect("/login")}>
              Login
            </span>
          </p>
        </form>
